...
def poems():
    ...
    content='/home/rasberrypi/Downloads/Capstone/rhymes/'
    path = content + rhyme
    pygame.init()
...
def stories():
    ...
    content='/home/rasberrypi/Downloads/Capstone/stories_audio/'
...
def conversation(query):
    ...
    df = pd.read_csv('/home/rasberrypi/Downloads/Capstone/answer.csv',encoding="ISO-8859-1")
    X = df['query']
    y = df['text']
    ...
    loaded_model = tf.keras.models.load_model('/home/rasberrypi/myproject/LSTM_94_97.h5')
...
def start():
    ...
    if "hello" in wake_word:
        pygame.init()
        pygame.mixer.music.load("/home/rasberrypi/Downloads/Capstone/wake.mp3")
        pygame.mixer.music.play()
        while pygame.mixer.music.get_busy():
            time.sleep(1)
        pygame.quit()
...
pygame.init()
pygame.mixer.music.load("/home/rasberrypi/Downloads/Capstone/intro.mp3")
pygame.mixer.music.play()
while pygame.mixer.music.get_busy():
    time.sleep(1)
pygame.quit()
